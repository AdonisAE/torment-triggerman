...
public class Pickup : MonoBehaviour {
	...
	public enum PickupType {Speed, Rapid, Bullet, Bounce, Pierce, Health, Demon}
	...
	void OnTriggerEnter (Collider other) {
		...
		switch (pickupType) {
            ...
            case PickupType.Speed:
                other.GetComponentInChildren<PlayerMovement>().speed = 5f;
                break;

            case PickupType.Rapid:
                other.GetComponentInChildren<PlayerShooting>().RapidTimer = 0;
                break;

            case PickupType.Demon:
                if (other.GetComponentInChildren<PlayerShooting>().numberOfBullets <= 36)
                {
                    other.GetComponentInChildren<PlayerShooting>().numberOfBullets++;
                }
                ...
                other.GetComponentInChildren<PlayerShooting>().PierceTimer = 0;
                other.GetComponentInChildren<PlayerShooting>().BounceTimer = 0;
                other.GetComponentInChildren<PlayerHealth>().AddHealth(100);
                break;
        }
...
//Code inspiried by How to Make a Power Up system in Unity
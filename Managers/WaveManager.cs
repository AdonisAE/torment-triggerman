...
public class WaveManager : MonoBehaviour {
	...
	// to make sure they are not visisble when they spawn. 
	...
	public int totalToSpawnForWave;
	...
	IEnumerator StartNextWave() {
		...
		foreach (Wave.Entry entry in currentWave.entries) {
            ...
            ct.count = totalToSpawnForWave;
            enemyNumber.GetComponent<Animation>().Play();
        }
    ...
    public void SetNormal(int diff)
    {
        startingDifficulty = diff;
    }

    public void SetHard(int diff)
    {
        startingDifficulty = diff;
    }
    public void SetEasy(int diff)
    {
        startingDifficulty = diff;
        //dmg.damage = 30;
    }

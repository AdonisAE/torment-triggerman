...
public class PlayerShooting : MonoBehaviour {
    ...
    public float bounceDuration = 30;
    public float pierceDuration = 20;
    public float rapidDuration = 15;
    ...
    // Reference to the UI's bouncing bullets image.
    public Image bounceImage;
    // Reference to the UI's piercing bullets image.
    public Image pierceImage;
    // Refernce to the UI's rapid fire image.
    ...
    public float RapidTimer {
        get { return rapidTimer; }
        set { rapidTimer = value; }
    }
    ...
    void Update() {
        ...
        if (rapid) {
            timeBetweenBullets = 0.125f;
        }
        else { timeBetweenBullets = 0.2f; }
        rapidImage.gameObject.SetActive(rapid);
